export type LanguageCode = 'en' | 'es' | 'fr' | 'de' | 'hi' | 'it' | 'pt';
...
export interface TranslationSet {
  ...
  astrologicalSignificanceLabel: string;
  lunarPhaseInterpretations: Record<string, string>;
  lunarPhaseAstrology: Record<string, string>;
  ...
  seoSectionAge: string;
  seoSectionBmi: string;
  seoSectionDiscount: string;
  seoSectionPercentage: string;
  seoKeywordsBmi: string;
  seoKeywordsAge: string;
  seoKeywordsDiscount: string;
  seoKeywordsPercentage: string;
}
...
export const translations: Record<LanguageCode, TranslationSet> = {
  en: {
    ...
    lunarPhaseAstrology: {
      ...
      last_quarter: 'A phase of internal reflection and closing chapters to prepare for the new.',
  ...
  es: {
    ...
    errorTooOld: 'Por favor, introduce una fecha más reciente (en los últimos 150 años).',
    ...
    copiedLabel: '¡Copiado!',
    holidayLabel: 'Próximo Feriado (Opcional)',
    daysUntilHoliday: '¡Faltan {days} días para tu feriado!',
    ...
    hourPlaceholder: 'HH',
    minutePlaceholder: 'MM',
    locationPlaceholder: 'ej. Nueva York, EE. UU.',
    ...
    astrologicalSignificanceLabel: 'Significado Astrológico',
    lunarPhaseInterpretations: {
      new_moon: 'Un momento para nuevos comienzos, establecer intenciones y plantar semillas para el futuro.',
      waxing_crescent: 'Una fase de crecimiento, creación de impulso y dar los primeros pasos hacia tus metas.',
      first_quarter: 'Un momento para la acción, superar obstáculos y tomar decisiones.',
      waxing_gibbous: 'Un período de refinamiento, ajuste y preparación para la manifestación completa.',
      full_moon: 'Un momento de culminación, cosecha y emociones intensificadas.',
      waning_gibbous: 'Una fase de gratitud, compartir y reflexionar sobre lo que se ha logrado.',
      last_quarter: 'Un momento para la liberación, dejar ir y limpiar lo que ya no te sirve.',
      waning_crescent: 'Un período de descanso, entrega y profunda introspección antes del próximo ciclo.'
    },
    lunarPhaseAstrology: {
      new_moon: 'Simboliza el inicio de un nuevo ciclo, ofreciendo un borrón y cuenta nueva y energía fresca.',
      waxing_crescent: 'Representa el surgimiento de ideas y el impulso inicial para manifestar deseos.',
      first_quarter: 'Una fase dinámica de tensión que impulsa el progreso y requiere compromiso.',
      waxing_gibbous: 'Se centra en perfeccionar los detalles y mantener el rumbo hacia la finalización.',
      full_moon: 'Representa el pico de energía, iluminación y la realización de intenciones.',
      waning_gibbous: 'Se centra en distribuir la sabiduría y procesar las lecciones del ciclo.',
      last_quarter: 'Una fase de reflexión interna y cierre de capítulos para prepararse para lo nuevo.',
      waning_crescent: 'Simboliza la liberación final y la sabiduría ganada a través del viaje.'
    },
    ...
    calculatePercentageBtn: 'Calcular Porcentaje',
    percentageResult: '{percentage}% de {number} es {result}',
    bmiCategories: {
    ...
    ageDescription: 'Calcula tu edad exacta en años, meses, días e incluso segundos. Descubre tu signo zodiacal y piedra de nacimiento.',
    bmiDescription: 'Calcula rápidamente tu Índice de Masa Corporal (IMC) para entender tu categoría de peso y estado de salud.',
    discountDescription: 'Descubre fácilmente cuánto ahorras y el precio final después de aplicar un porcentaje de descuento.',
    percentageDescription: 'Calcula porcentajes de cualquier número rápidamente para tareas de negocios, escuela o vida diaria.',
    home: 'Inicio',
    about: 'Acerca de',
    contact: 'Contacto',
    aboutTitle: 'Acerca de Utility Hub Pro',
    aboutContent: 'Utility Hub Pro es tu destino único para herramientas de utilidad profesional, precisas y fáciles de usar. Nuestra misión es proporcionar calculadoras de alta calidad que ayuden a las personas en sus tareas diarias, desde el seguimiento de la salud hasta la planificación financiera.',
    contactTitle: 'Contáctanos',
    contactName: 'Nombre',
    contactEmail: 'Correo Electrónico',
    contactMessage: 'Mensaje',
    contactSubmit: 'Enviar Mensaje',
    contactSuccess: '¡Gracias! Tu mensaje ha sido enviado con éxito.',
    privacyTitle: 'Privacidad Primero',
    privacyDesc: 'Tus datos nunca salen de tu navegador. No almacenamos tu información personal ni los resultados de tus cálculos.',
    speedTitle: 'Velocidad Rayo',
    speedDesc: 'Optimizado para el rendimiento, nuestras herramientas proporcionan resultados instantáneos con animaciones fluidas.',
    globalTitle: 'Soporte Global',
    ...
    seoSectionTitle: '¿Por qué usar nuestro Utility Hub?',
    seoSectionContent: 'Nuestro Multi-Tool Utility Hub está diseñado para simplificar sus cálculos diarios. Ya sea que necesite saber su edad exacta, verificar su índice de masa corporal (IMC) o calcular un descuento para su próxima compra, ofrecemos herramientas precisas y fáciles de usar en un solo lugar.',
    seoSectionAge: 'Calcule su edad exacta en años, meses, días e incluso segundos con nuestra herramienta de alta precisión. Incluye detalles de la carta natal, signos del zodiaco y estadísticas de vida como el total de latidos del corazón y respiraciones.',
    seoSectionBmi: 'Calcule su Índice de Masa Corporal (IMC) al instante con nuestra herramienta de precisión. Perfecto para el seguimiento de la salud, el estado físico y las categorías de peso (bajo peso, normal, sobrepeso, obeso) utilizando unidades métricas o imperiales.',
    seoSectionDiscount: 'Ahorre dinero con nuestra Calculadora de Descuentos. Encuentre rápidamente el precio final y el ahorro total para cualquier venta. Ideal para compras, planificación de presupuestos y descuentos minoristas.',
    seoSectionPercentage: 'Nuestra Calculadora de Porcentajes maneja todas sus necesidades matemáticas. Calcule fácilmente porcentajes de números, aumentos o disminuciones porcentuales para negocios, escuela y finanzas diarias.',
    seoKeywordsBmi: 'Calculadora de IMC, Índice de Masa Corporal, Seguimiento de Salud, Categoría de Peso, IMC Métrico, IMC Imperial, Herramienta de Fitness',
    seoKeywordsAge: 'Calculadora de Edad, Edad Exacta, Carta Natal, Signo del Zodiaco, Estadísticas de Vida, Cuenta Regresiva de Cumpleaños',
    seoKeywordsDiscount: 'Calculadora de Descuentos, Precio de Oferta, Herramienta de Compras, Calculadora de Ahorros, Descuento Minorista',
    seoKeywordsPercentage: 'Calculadora de Porcentajes, Herramienta Matemática, Aumento Porcentual, Disminución Porcentual, Calculadora Financiera'
  },
  fr: {
    title: 'Utility Hub Pro',
    ...
    errorTooOld: 'Veuillez saisir une date plus récente (au cours des 150 dernières années).',
    ...
    copiedLabel: 'Copié !',
    holidayLabel: 'Prochain Jour Férié (Optionnel)',
    daysUntilHoliday: 'Plus que {days} jours avant votre jour férié !',
    ...
    hourPlaceholder: 'HH',
    minutePlaceholder: 'MM',
    locationPlaceholder: 'ex. New York, USA',
    ...
    astrologicalSignificanceLabel: 'Signification Astrologique',
    lunarPhaseInterpretations: {
      new_moon: 'Un temps pour de nouveaux départs, fixer des intentions et planter des graines pour l\'avenir.',
      waxing_crescent: 'Une phase de croissance, de renforcement de l\'élan et de premiers pas vers vos objectifs.',
      first_quarter: 'Un temps pour l\'action, surmonter les obstacles et prendre des décisions.',
      waxing_gibbous: 'Une période de raffinement, d\'ajustement et de préparation à la manifestation complète.',
      full_moon: 'Un temps de point culminant, de récolte et d\'émotions accrues.',
      waning_gibbous: 'Une phase de gratitude, de partage et de réflexion sur ce qui a été accompli.',
      last_quarter: 'Un temps pour le relâchement, le lâcher-prise et le nettoyage de ce qui ne vous sert plus.',
      waning_crescent: 'Une période de repos, d\'abandon et d\'introspection profonde avant le prochain cycle.'
    },
    lunarPhaseAstrology: {
      new_moon: 'Symbolise le début d\'un nouveau cycle, offrant une page blanche et une énergie fraîche.',
      waxing_crescent: 'Représente l\'émergence d\'idées et l\'élan initial pour manifester les désirs.',
      first_quarter: 'Une phase dynamique de tension qui stimule le progrès et exige de l\'engagement.',
      waxing_gibbous: 'Se concentre sur le perfectionnement des détails et le maintien du cap vers l\'achèvement.',
      full_moon: 'Représente le pic d\'énergie, l\'illumination et la réalisation des intentions.',
      waning_gibbous: 'Se concentre sur la distribution de la sagesse et le traitement des leçons du cycle.',
      last_quarter: 'Une phase de réflexion interne et de clôture de chapitres pour se préparer au nouveau.',
      waning_crescent: 'Symbolise la libération finale et la sagesse acquise tout au long du voyage.'
    },
    ...
    calculatePercentageBtn: 'Calculer le Pourcentage',
    percentageResult: '{percentage}% de {number} est {result}',
    bmiCategories: {
    ...
    ageDescription: 'Calculez votre âge exact en années, mois, jours et même secondes. Découvrez votre signe du zodiaque et votre pierre de naissance.',
    bmiDescription: 'Calculez rapidement votre indice de masse corporelle (IMC) pour comprendre votre catégorie de poids et votre état de santé.',
    discountDescription: 'Découvrez facilement combien vous économisez et le prix final après avoir appliqué un pourcentage de remise.',
    percentageDescription: 'Calculez rapidement les pourcentages de n\'importe quel nombre pour les tâches professionnelles, scolaires ou quotidiennes.',
    home: 'Accueil',
    about: 'À propos',
    contact: 'Contact',
    aboutTitle: 'À propos de Utility Hub Pro',
    aboutContent: 'Utility Hub Pro est votre destination unique pour des outils utilitaires professionnels, précis et faciles à utiliser. Notre mission est de fournir des calculateurs de haute qualité qui aident les gens dans leurs tâches quotidiennes, du suivi de la santé à la planification financière.',
    ...
    privacyTitle: 'La vie privée d\'abord',
    privacyDesc: 'Vos données ne quittent jamais votre navigateur. Nous ne stockons pas vos informations personnelles ni les résultats de vos calculs.',
    speedTitle: 'Rapide comme l\'éclair',
    speedDesc: 'Optimisés pour la performance, nos outils fournissent des résultats instantanés avec des animations fluides.',
    globalTitle: 'Support mondial',
    ...
    seoSectionTitle: 'Pourquoi utiliser notre Utility Hub ?',
    seoSectionContent: 'Notre Multi-Tool Utility Hub est conçu pour simplifier vos calculs quotidiens. Que vous ayez besoin de connaître votre âge exact, de vérifier votre indice de masse corporelle (IMC) ou de calculer une remise pour votre prochain achat, nous fournissons des outils précis et faciles à utiliser en un seul endroit.',
    seoSectionAge: 'Calculez votre âge exact en années, mois, jours et même secondes avec notre outil de haute précision. Comprend des détails sur le thème natal, les signes du zodiaque et des statistiques de vie comme le nombre total de battements de cœur et de respirations.',
    seoSectionBmi: 'Calculez votre indice de masse corporelle (IMC) instantanément avec notre outil précis. Parfait pour suivre la santé, la forme physique et les catégories de poids (insuffisance pondérale, normale, surpoids, obèse) en utilisant des unités métriques ou impériales.',
    seoSectionDiscount: 'Économisez de l\'argent avec notre calculateur de remise. Trouvez rapidement le prix final et les économies totales pour n\'importe quelle vente. Idéal pour le shopping, la planification budgétaire et les remises au détail.',
    seoSectionPercentage: 'Notre calculateur de pourcentage gère tous vos besoins mathématiques. Calculez facilement les pourcentages de nombres, les augmentations ou les diminutions de pourcentage pour les affaires, l\'école et les finances quotidiennes.',
    seoKeywordsBmi: 'Calculateur d\'IMC, Indice de Masse Corporelle, Suivi de Santé, Catégorie de Poids, IMC Métrique, IMC Impérial, Outil de Fitness',
    seoKeywordsAge: 'Calculateur d\'Âge, Âge Exact, Thème Natal, Signe du Zodiaque, Statistiques de Vie, Compte à Rebours d\'Anniversaire',
    seoKeywordsDiscount: 'Calculateur de Remise, Prix de Vente, Outil de Shopping, Calculateur d\'Économies, Remise au Détail',
    seoKeywordsPercentage: 'Calculateur de Pourcentage, Outil Mathématique, Augmentation en Pourcentage, Diminution en Pourcentage, Calculateur Financier'
  },
  de: {
    title: 'Utility Hub Pro',
    ...
    errorTooOld: 'Bitte geben Sie ein aktuelleres Datum ein (innerhalb der letzten 150 Jahre).',
    ...
    hourPlaceholder: 'SS',
    minutePlaceholder: 'MM',
    locationPlaceholder: 'z.B. New York, USA',
    ...
    interpretationLabel: 'Interpretation',
    astrologicalSignificanceLabel: 'Astrologische Bedeutung',
    lunarPhaseInterpretations: {
      new_moon: 'Eine Zeit für Neuanfänge, das Setzen von Intentionen und das Pflanzen von Samen für die Zukunft.',
      waxing_crescent: 'Eine Phase des Wachstums, des Aufbaus von Dynamik und der ersten Schritte in Richtung Ihrer Ziele.',
      first_quarter: 'Eine Zeit für Taten, das Überwinden von Hindernissen und das Treffen von Entscheidungen.',
      waxing_gibbous: 'Eine Zeit der Verfeinerung, Anpassung und Vorbereitung auf die vollständige Manifestation.',
      full_moon: 'Eine Zeit des Höhepunkts, der Ernte und gesteigerter Emotionen.',
      waning_gibbous: 'Eine Phase der Dankbarkeit, des Teilens und Reflektierens über das Erreichte.',
      last_quarter: 'Eine Zeit des Loslassens, des Freigebens und des Aufräumens dessen, was Ihnen nicht mehr dient.',
      waning_crescent: 'Eine Zeit der Ruhe, des Loslassens und der tiefen Selbstreflexion vor dem nächsten Zyklus.'
    },
    lunarPhaseAstrology: {
      new_moon: 'Symbolisiert den Beginn eines neuen Zyklus und bietet einen Neuanfang und frische Energie.',
      waxing_crescent: 'Repräsentiert das Entstehen von Ideen und den ersten Impuls zur Manifestation von Wünschen.',
      first_quarter: 'Eine dynamische Phase der Spannung, die den Fortschritt vorantreibt und Engagement erfordert.',
      waxing_gibbous: 'Konzentriert sich auf das Perfektionieren von Details und das Beibehalten des Kurses bis zum Abschluss.',
      full_moon: 'Repräsentiert den Höhepunkt der Energie, Erleuchtung und die Verwirklichung von Absichten.',
      waning_gibbous: 'Konzentriert sich auf die Weitergabe von Weisheit und die Verarbeitung der Lektionen des Zyklus.',
      last_quarter: 'Eine Phase der inneren Reflexion und des Abschlusses von Kapiteln zur Vorbereitung auf das Neue.',
      waning_crescent: 'Symbolisiert das endgültige Loslassen und die auf der Reise gewonnene Weisheit.'
    },
    ...
    calculatePercentageBtn: 'Prozent berechnen',
    percentageResult: '{percentage}% von {number} ist {result}',
    bmiCategories: {
    ...
    ageDescription: 'Berechnen Sie Ihr genaues Alter in Jahren, Monaten, Tagen und sogar Sekunden. Entdecken Sie Ihr Sternzeichen und Ihren Geburtsstein.',
    bmiDescription: 'Berechnen Sie schnell Ihren Body-Mass-Index (BMI), um Ihre Gewichtsklasse und Ihren Gesundheitszustand zu verstehen.',
    discountDescription: 'Finden Sie ganz einfach heraus, wie viel Sie sparen und wie hoch der Endpreis nach Abzug eines Rabattprozentsatzes ist.',
    percentageDescription: 'Berechnen Sie Prozentsätze jeder Zahl schnell für Geschäfts-, Schul- oder Alltagsaufgaben.',
    home: 'Startseite',
    about: 'Über uns',
    contact: 'Kontakt',
    aboutTitle: 'Über Utility Hub Pro',
    aboutContent: 'Utility Hub Pro ist Ihre zentrale Anlaufstelle für professionelle, präzise und benutzerfreundliche Utility-Tools. Unsere Mission ist es, hochwertige Rechner bereitzustellen, die Menschen bei ihren täglichen Aufgaben unterstützen, von der Gesundheitsüberwachung bis zur Finanzplanung.',
    ...
    privacyDesc: 'Ihre Daten verlassen niemals Ihren Browser. Wir speichern keine persönlichen Informationen oder Berechnungsergebnisse.',
    speedTitle: 'Blitzschnell',
    speedDesc: 'Unsere auf Leistung optimierten Tools liefern sofortige Ergebnisse mit flüssigen Animationen.',
    globalTitle: 'Globaler Support',
    ...
    seoSectionTitle: 'Warum sollten Sie unser Utility Hub nutzen?',
    seoSectionContent: 'Unser Multi-Tool Utility Hub wurde entwickelt, um Ihre täglichen Berechnungen zu vereinfachen. Egal, ob Sie Ihr genaues Alter wissen, Ihren Body-Mass-Index (BMI) überprüfen oder einen Rabatt für Ihren nächsten Einkauf berechnen müssen, wir bieten präzise und einfach zu bedienende Tools an einem Ort.',
    seoSectionAge: 'Berechnen Sie Ihr genaues Alter in Jahren, Monaten, Tagen und sogar Sekunden mit unserem hochpräzisen Tool. Enthält Details zum Geburtshoroskop, Sternzeichen und Lebensstatistiken wie die Gesamtzahl der Herzschläge und Atemzüge.',
    seoSectionBmi: 'Berechnen Sie Ihren Body-Mass-Index (BMI) sofort mit unserem präzisen Tool. Perfekt zur Verfolgung von Gesundheit, Fitness und Gewichtsklassen (Untergewicht, Normal, Übergewicht, Adipositas) mit metrischen oder imperialen Einheiten.',
    seoSectionDiscount: 'Sparen Sie Geld mit unserem Rabattrechner. Finden Sie schnell den Endpreis und die Gesamtersparnis für jeden Verkauf. Ideal für Shopping, Budgetplanung und Einzelhandelsrabatte.',
    seoSectionPercentage: 'Unser Prozentrechner erledigt alle Ihre mathematischen Anforderungen. Berechnen Sie ganz einfach Prozentsätze von Zahlen, prozentuale Zunahmen oder Abnahmen für Beruf, Schule und tägliche Finanzen.',
    seoKeywordsBmi: 'BMI-Rechner, Body-Mass-Index, Gesundheits-Tracker, Gewichtsklasse, Metrischer BMI, Imperialer BMI, Fitness-Tool',
    seoKeywordsAge: 'Altersrechner, Genaues Alter, Geburtshoroskop, Sternzeichen, Lebensstatistiken, Geburtstags-Countdown',
    seoKeywordsDiscount: 'Rabattrechner, Verkaufspreis, Shopping-Tool, Sparrechner, Einzelhandelsrabatt, Budgetplanung',
    seoKeywordsPercentage: 'Prozentrechner, Mathe-Tool, Prozentuale Zunahme, Prozentuale Abnahme, Finanzrechner'
  },
  hi: {
    ...
    errorTooOld: 'कृपया अधिक हाल की तारीख दर्ज करें (पिछले 150 वर्षों के भीतर)।',
    ...
    locationPlaceholder: 'जैसे न्यूयॉर्क, यूएसए',
    ...
    astrologicalSignificanceLabel: 'ज्योतिषीय महत्व',
    lunarPhaseInterpretations: {
      new_moon: 'नई शुरुआत, इरादे तय करने और भविष्य के लिए बीज बोने का समय।',
      waxing_crescent: 'विकास का एक चरण, गति बनाना और अपने लक्ष्यों की ओर पहला कदम उठाना।',
      first_quarter: 'कार्रवाई करने, बाधाओं को दूर करने और निर्णय लेने का समय।',
      waxing_gibbous: 'पूर्ण प्रकटीकरण के लिए शोधन, समायोजन और तैयारी की अवधि।',
      full_moon: 'चरमोत्कर्ष, फसल और बढ़ी हुई भावनाओं का समय।',
      waning_gibbous: 'कृतज्ञता, साझा करने और जो हासिल किया गया है उस पर विचार करने का चरण।',
      last_quarter: 'मुक्ति का समय, जाने देना और जो अब आपके काम का नहीं है उसे साफ करना।',
      waning_crescent: 'अगले चक्र से पहले आराम, आत्मसमर्पण और गहरी आत्मनिरीक्षण की अवधि।'
    },
    lunarPhaseAstrology: {
      new_moon: 'एक नए चक्र की शुरुआत का प्रतीक है, जो एक नई शुरुआत और ताज़ा ऊर्जा प्रदान करता है।',
      waxing_crescent: 'विचारों के उभरने और इच्छाओं को प्रकट करने के शुरुआती प्रयास का प्रतिनिधित्व करता है।',
      first_quarter: 'तनाव का एक गतिशील चरण जो प्रगति को संचालित करता है और प्रतिबद्धता की आवश्यकता होती है।',
      waxing_gibbous: 'विवरणों को पूर्ण करने और पूरा होने की दिशा में बने रहने पर ध्यान केंद्रित करता है।',
      full_moon: 'ऊर्जा के शिखर, रोशनी और इरादों की प्राप्ति का प्रतिनिधित्व करता है।',
      waning_gibbous: 'ज्ञान वितरित करने और चक्र के पाठों को संसाधित करने पर ध्यान केंद्रित करता है।',
      last_quarter: 'नए की तैयारी के लिए आंतरिक प्रतिबिंब और अध्यायों को बंद करने का एक चरण।',
      waning_crescent: 'अंतिम मुक्ति और यात्रा के माध्यम से प्राप्त ज्ञान का प्रतीक है।'
    },
    ...
    calculatePercentageBtn: 'प्रतिशत की गणना करें',
    percentageResult: '{number} का {percentage}% {result} है',
    bmiCategories: {
      underweight: 'कम वजन',
      normal: 'सामान्य वजन',
      overweight: 'अधिक वजन',
    ...
    ageDescription: 'वर्षों, महीनों, दिनों और यहाँ तक कि सेकंडों में अपनी सटीक आयु की गणना करें। अपनी राशि और जन्म का रत्न खोजें।',
    bmiDescription: 'अपने वजन की श्रेणी और स्वास्थ्य स्थिति को समझने के लिए जल्दी से अपने बॉडी मास इंडेक्स (BMI) की गणना करें।',
    discountDescription: 'आसानी से पता लगाएं कि आप कितनी बचत करते हैं और छूट प्रतिशत लागू करने के बाद अंतिम मूल्य क्या है।',
    percentageDescription: 'व्यवसाय, स्कूल या दैनिक जीवन के कार्यों के लिए किसी भी संख्या के प्रतिशत की जल्दी से गणना करें।',
    home: 'होम',
    about: 'के बारे में',
    contact: 'संपर्क',
    aboutTitle: 'Utility Hub Pro के बारे में',
    aboutContent: 'Utility Hub Pro पेशेवर, सटीक और उपयोग में आसान उपयोगिता उपकरणों के लिए आपका वन-स्टॉप गंतव्य है। हमारा मिशन उच्च गुणवत्ता वाले कैलकुलेटर प्रदान करना है जो लोगों को स्वास्थ्य ट्रैकिंग से लेकर वित्तीय नियोजन तक उनके दैनिक कार्यों में मदद करते हैं।',
    contactTitle: 'हमसे संपर्क करें',
    contactName: 'नाम',
    contactEmail: 'ईमेल',
    contactMessage: 'संदेश',
    contactSubmit: 'संदेश भेजें',
    contactSuccess: 'धन्यवाद! आपका संदेश सफलतापूर्वक भेज दिया गया है।',
    privacyTitle: 'गोपनीयता पहले',
    privacyDesc: 'आपका डेटा आपके ब्राउज़र से बाहर कभी नहीं जाता है। हम आपकी व्यक्तिगत जानकारी या गणना परिणामों को संग्रहीत नहीं करते हैं।',
    speedTitle: 'बिजली की तरह तेज़',
    speedDesc: 'प्रदर्शन के लिए अनुकूलित, हमारे उपकरण सुचारू एनिमेशन के साथ त्वरित परिणाम प्रदान करते हैं।',
    globalTitle: 'वैश्विक समर्थन',
    ...
    seoSectionTitle: 'हमारे यूटिलिटी हब का उपयोग क्यों करें?',
    seoSectionContent: 'हमारा मल्टी-टूल यूटिलिटी हब आपकी दैनिक गणनाओं को सरल बनाने के लिए डिज़ाइन किया गया है। चाहे आपको अपनी सटीक आयु जाननी हो, अपने बॉडी मास इंडेक्स (BMI) की जांच करनी हो, या अपनी अगली खरीदारी के लिए छूट की गणना करनी हो, हम एक ही स्थान पर सटीक और उपयोग में आसान उपकरण प्रदान करते हैं।',
    seoSectionAge: 'हमारे उच्च-सटीक टूल के साथ वर्षों, महीनों, दिनों और यहां तक कि सेकंड में अपनी सटीक आयु की गणना करें। इसमें जन्म कुंडली विवरण, राशि चिन्ह और कुल दिल की धड़कन और सांसों जैसे जीवन आँकड़े शामिल हैं।',
    seoSectionBmi: 'हमारे सटीक टूल के साथ तुरंत अपने बॉडी मास इंडेक्स (बीएमआई) की गणना करें। मीट्रिक या इंपीरियल इकाइयों का उपयोग करके स्वास्थ्य, फिटनेस और वजन श्रेणियों (कम वजन, सामान्य, अधिक वजन, मोटापे) को ट्रैक करने के लिए बिल्कुल सही।',
    seoSectionDiscount: 'हमारे डिस्काउंट कैलकुलेटर के साथ पैसे बचाएं। किसी भी सेल के लिए अंतिम मूल्य और कुल बचत जल्दी से खोजें। खरीदारी, बजट योजना और खुदरा छूट के लिए आदर्श।',
    seoSectionPercentage: 'हमारा प्रतिशत कैलकुलेटर आपकी सभी गणितीय आवश्यकताओं को संभालता है। व्यापार, स्कूल और दैनिक वित्त के लिए संख्याओं के प्रतिशत, प्रतिशत वृद्धि या कमी की आसानी से गणना करें।',
    seoKeywordsBmi: 'बीएमआई कैलकुलेटर, बॉडी मास इंडेक्स, हेल्थ ट्रैकर, वजन श्रेणी, मीट्रिक बीएमआई, इंपीरियल बीएमआई, फिटनेस टूल',
    seoKeywordsAge: 'आयु कैलकुलेटर, सटीक आयु, जन्म कुंडली, राशि चिन्ह, जीवन आँकड़े, जन्मदिन उलटी गिनती',
    seoKeywordsDiscount: 'छूट कैलकुलेटर, बिक्री मूल्य, खरीदारी उपकरण, बचत कैलकुलेटर, खुदरा छूट, बजट योजना',
    seoKeywordsPercentage: 'प्रतिशत कैलकुलेटर, गणित उपकरण, प्रतिशत वृद्धि, प्रतिशत कमी, वित्तीय कैलकुलेटर'
  },
  it: {
    title: 'Utility Hub Pro',
    subtitle: 'Strumenti di utilità professionale tutto in uno. Calcola istantaneamente la tua età esatta, i livelli di BMI e gli sconti sugli acquisti.',
    ...
    resultsTitle: 'La Tua Età Esatta',
    ageLabel: 'Età',
    lunarAge: 'Età Lunare',
    years: 'Anni',
    months: 'Mesi',
    ...
    lifeStatsTitle: 'Statistiche di Vita (Stimate)',
    heartbeats: 'Battiti Cardiaci',
    eyeBlinks: 'Battiti di Ciglia',
    sleepTime: 'Tempo di Sonno',
    breathCount: 'Respiri',
    weeks: 'Settimane',
    ageSummary: 'Hai {years} anni, {months} mesi e {days} giorni.',
    errorInvalidDate: 'Inserisci una data valida.',
    errorFutureDate: 'La data di nascita non può essere nel futuro.',
    errorInvalidYear: 'Inserisci un anno valido.',
    errorBirthAfterTarget: 'La data di nascita non può essere successiva all\'anno target.',
    errorStartDateAfterEndDate: 'La data di inizio non può essere successiva alla data di fine.',
    errorTooOld: 'Inserisci una data più recente (negli ultimi 150 anni).',
    errorInvalidPrice: 'Inserisci un prezzo positivo valido.',
    errorInvalidDiscount: 'Lo sconto deve essere compreso tra 0 e 100.',
    date1Label: 'Data di Inizio',
    date2Label: 'Data di Fine',
    compareBtn: 'Calcola Differenza',
    differenceTitle: 'Differenza di Tempo',
    differenceSummary: 'La differenza è di {years} anni, {months} mesi e {days} giorni.',
    footerText: '© 2026 Utility Hub Pro. Tutti i diritti riservati.',
    seoTitle: 'Perché usare un calcolatore di età?',
    seoDescription: 'Un calcolatore di età è uno strumento che ti aiuta a determinare il tempo esatto trascorso dalla tua nascita.',
    selectLanguage: 'Lingua',
    shareBtn: 'Condividi Risultati',
    copyBtn: 'Copia negli Appunti',
    copiedLabel: 'Copiato!',
    holidayLabel: 'Prossima Festività (Opzionale)',
    daysUntilHoliday: 'Mancano {days} giorni alla tua festività!',
    dobRangeEndLabel: 'Fine Intervallo Data di Nascita (Opzionale)',
    ageRangeSummary: 'Il tuo intervallo di età è tra {min} e {max}.',
    easterDate: 'Data di Pasqua {year}',
    targetYearLabel: 'Anno Target (Opzionale)',
    holidayCountdownLabel: 'Conto alla rovescia per la festività',
    bmiCalculator: 'Calcolatore BMI',
    discountCalculator: 'Calcolatore Sconto',
    weightLabel: 'Peso (kg)',
    heightLabel: 'Altezza (cm)',
    originalPriceLabel: 'Prezzo Originale',
    discountPercentageLabel: 'Sconto %',
    calculateBmiBtn: 'Calcola BMI',
    calculateDiscountBtn: 'Calcola Sconto',
    weightPlaceholder: 'es. 70',
    ...
    bmiResult: 'Il tuo BMI è {bmi}',
    bmiCategory: 'Categoria: {category}',
    discountResult: 'Prezzo Finale: {price}',
    savingsLabel: 'Risparmi: {savings}',
    birthChartTitle: 'Il Tuo Tema Natale',
    birthLocationLabel: 'Luogo di Nascita (Città, Paese)',
    sunSignLabel: 'Segno Solare',
    moonSignLabel: 'Segno Lunare',
    risingSignLabel: 'Ascendente',
    chineseZodiacLabel: 'Zodiaco Cinese',
    lunarPhaseLabel: 'Fase Lunare',
    interpretationLabel: 'Interpretazione',
    astrologicalSignificanceLabel: 'Significato Astrologico',
    lunarPhaseInterpretations: {
      new_moon: 'Un momento per nuovi inizi, impostare intenzioni e piantare semi per il futuro.',
      waxing_crescent: 'Una fase di crescita, creazione di slancio e primi passi verso i tuoi obiettivi.',
      first_quarter: 'Un momento per l\'azione, superare ostacoli e prendere decisioni.',
      waxing_gibbous: 'Un periodo di affinamento, aggiustamento e preparazione per la piena manifestazione.',
      full_moon: 'Un momento di culmine, raccolto ed emozioni intensificate.',
      waning_gibbous: 'Una fase di gratitudine, condivisione e riflessione su ciò che è stato realizzato.',
      last_quarter: 'Un momento per il rilascio, lasciare andare e pulire ciò che non ti serve più.',
      waning_crescent: 'Un periodo di riposo, resa e profonda introspezione prima del prossimo ciclo.'
    },
    lunarPhaseAstrology: {
      new_moon: 'Simboleggia l\'inizio di un nuovo ciclo, offrendo una tabula rasa ed energia fresca.',
      waxing_crescent: 'Rappresenta l\'emergere di idee e la spinta iniziale per manifestare i desideri.',
      first_quarter: 'Una fase dinamica di tensione che spinge al progresso e richiede impegno.',
      waxing_gibbous: 'Si concentra sul perfezionamento dei dettagli e sul mantenimento della rotta verso il completamento.',
      full_moon: 'Rappresenta il picco di energia, illuminazione e la realizzazione delle intenzioni.',
      waning_gibbous: 'Si concentra sulla distribuzione della saggezza e sull\'elaborazione delle lezioni del ciclo.',
      last_quarter: 'Una fase di riflessione interna e chiusura di capitoli per prepararsi al nuovo.',
      waning_crescent: 'Simboleggia il rilascio finale e la saggezza guadagnata attraverso il viaggio.'
    },
    planetaryPositionsTitle: 'Posizioni Planetarie',
    housesTitle: 'Case Astrologiche',
    mercuryLabel: 'Mercurio',
    venusLabel: 'Venere',
    marsLabel: 'Marte',
    jupiterLabel: 'Giove',
    saturnLabel: 'Saturno',
    uranusLabel: 'Urano',
    neptuneLabel: 'Nettuno',
    plutoLabel: 'Plutone',
    houseLabel: 'Casa {n}',
    elementLabel: 'Elemento',
    modalityLabel: 'Modalità',
    rulingPlanetLabel: 'Pianeta Reggente',
    degreeLabel: 'Grado',
    percentageCalculator: 'Calcolatore Percentuale',
    numberLabel: 'Numero',
    percentageLabel: 'Percentuale %',
    calculatePercentageBtn: 'Calcola Percentuale',
    percentageResult: '{percentage}% di {number} è {result}',
    bmiCategories: {
    ...
    ageDescription: 'Calcola la tua età esatta in anni, mesi, giorni e persino secondi. Scopri il tuo segno zodiacale e la tua pietra portafortuna.',
    bmiDescription: 'Calcola rapidamente il tuo Indice di Massa Corporea (BMI) per capire la tua categoria di peso e lo stato di salute.',
    discountDescription: 'Scopri facilmente quanto risparmi e il prezzo finale dopo aver applicato una percentuale di sconto.',
    percentageDescription: 'Calcola rapidamente le percentuali di qualsiasi numero per compiti di lavoro, scuola o vita quotidiana.',
    home: 'Home',
    about: 'Chi Siamo',
    contact: 'Contatti',
    aboutTitle: 'Informazioni su Utility Hub Pro',
    aboutContent: 'Utility Hub Pro è la tua destinazione unica per strumenti di utilità professionali, precisi e facili da usare. La nostra missione è fornire calcolatori di alta qualità che aiutino le persone nelle loro attività quotidiane.',
    ...
    privacyDesc: 'I tuoi dati non lasciano mai il tuo browser. Non memorizziamo le tue informazioni personali né i risultati dei tuoi calcoli.',
    speedTitle: 'Velocità Lampo',
    speedDesc: 'Ottimizzati per le prestazioni, i nostri strumenti forniscono risultati istantanei con animazioni fluide.',
    globalTitle: 'Supporto Globale',
    globalDesc: 'Disponibile in più lingue e fusi orari per servire utenti in tutto il mondo.',
    privacyPolicy: 'Informativa sulla Privacy',
    termsOfService: 'Termini di Servizio',
    privacyPolicyTitle: 'Informativa sulla Privacy',
    privacyPolicyLastUpdated: 'Ultimo aggiornamento: 25 marzo 2026',
    privacyPolicySections: [
      { title: 'Introduzione', content: 'Benvenuti in Utility Hub Pro. Apprezziamo la vostra privacy e ci impegniamo a proteggere i vostri dati personali.' },
      { title: 'Raccolta Dati', content: 'Non raccogliamo né memorizziamo alcuna informazione personale sui nostri server. Tutti i calcoli vengono eseguiti localmente nel browser.' }
    ],
    aspectsTitle: 'Aspetti Astrologici',
    aspectTypes: { conjunction: 'Congiunzione', sextile: 'Sestile', square: 'Quadrato', trine: 'Trigono', opposition: 'Opposizione' },
    aspectDescriptions: { conjunction: 'I pianeti sono vicini, fondendo le loro energie.', sextile: 'Un angolo armonioso di 60 gradi.', square: 'Un angolo impegnativo di 90 gradi.', trine: 'Un angolo favorevole di 120 gradi.', opposition: 'I pianeti sono a 180 gradi di distanza.' },
    planetNames: { sun: 'Sole', moon: 'Luna', mercury: 'Mercurio', venus: 'Venere', mars: 'Marte' },
    planetMeanings: { sun: 'Identità centrale.', moon: 'Emozioni e istinti.', mercury: 'Comunicazione e intelletto.', venus: 'Amore e bellezza.', mars: 'Azione ed energia.', rising: 'Personalità sociale.' },
    zodiacInterpretationsTitle: 'Interpretazioni dello Zodiaco',
    zodiacReferenceTitle: 'Esplora i 12 Segni Zodiacali',
    lightMode: 'Modalità Chiaro',
    darkMode: 'Modalità Scuro',
    zodiacSigns: { aquarius: 'Acquario', pisces: 'Pesci', aries: 'Ariete', taurus: 'Toro', gemini: 'Gemelli', cancer: 'Cancro', leo: 'Leone', virgo: 'Vergine', libra: 'Bilancia', scorpio: 'Scorpione', sagittarius: 'Sagittario', capricorn: 'Capricorno' },
    zodiacDescriptions: { aquarius: 'Innovativo e umanitario.', pisces: 'Compassionevole e intuitivo.', aries: 'Entusiasta e dinamico.', taurus: 'Forte e affidabile.', gemini: 'Versatile ed espressivo.', cancer: 'Intuitivo e protettivo.', leo: 'Drammatico e fiducioso.', virgo: 'Analitico e gentile.', libra: 'Diplomatico e artistico.', scorpio: 'Appassionato e tenace.', sagittarius: 'Ottimista e avventuroso.', capricorn: 'Disciplinato e ambizioso.' },
    chineseZodiacSigns: { rat: 'Topo', ox: 'Bue', tiger: 'Tigre', rabbit: 'Coniglio', dragon: 'Dragone', snake: 'Serpente', horse: 'Cavallo', goat: 'Capra', monkey: 'Scimmia', rooster: 'Gallo', dog: 'Cane', pig: 'Maiale' },
    chineseZodiacDescriptions: { rat: 'Ingegnoso.', ox: 'Diligente.', tiger: 'Coraggioso.', rabbit: 'Tranquillo.', dragon: 'Fiducioso.', snake: 'Saggio.', horse: 'Energico.', goat: 'Gentile.', monkey: 'Intelligente.', rooster: 'Lavoratore.', dog: 'Onesto.', pig: 'Generoso.' },
    lunarPhases: { new_moon: 'Luna Nuova', waxing_crescent: 'Luna Crescente', first_quarter: 'Primo Quarto', waxing_gibbous: 'Luna Gibbosa Crescente', full_moon: 'Luna Piena', waning_gibbous: 'Luna Gibbosa Calante', last_quarter: 'Ultimo Quarto', waning_crescent: 'Luna Calante' },
    birthstones: { january: 'Granato', february: 'Ametista', march: 'Acquamarina', april: 'Diamante', may: 'Smeraldo', june: 'Perla', july: 'Rubino', august: 'Peridoto', september: 'Zaffiro', october: 'Opale', november: 'Topazio', december: 'Turchese' },
    elements: { fire: 'Fuoco', earth: 'Terra', air: 'Aria', water: 'Acqua' },
    modalities: { cardinal: 'Cardinale', fixed: 'Fisso', mutable: 'Mutabile' },
    rulingPlanets: { sun: 'Sole', moon: 'Luna', mercury: 'Mercurio', venus: 'Venere', mars: 'Marte', jupiter: 'Giove', saturn: 'Saturno', uranus: 'Urano', neptune: 'Nettuno', pluto: 'Plutone' },
    elementMeanings: { fire: 'Energico e appassionato.', earth: 'Pratico e affidabile.', air: 'Intellettuale e sociale.', water: 'Emotivo e intuitivo.' },
    modalityMeanings: { cardinal: 'Iniziatori.', fixed: 'Costruttori.', mutable: 'Adattatori.' },
    rulingPlanetMeanings: { mars: 'Azione.', venus: 'Amore.', mercury: 'Comunicazione.', moon: 'Emozioni.', sun: 'Vitalità.', pluto: 'Trasformazione.', jupiter: 'Espansione.', saturn: 'Struttura.', uranus: 'Innovazione.', neptune: 'Sogni.' },
    sunSignDetailedDescription: 'Il Sole rappresenta la tua identità centrale.',
    sunSignInterpretations: { aries: 'Pioniere.', taurus: 'Ancora.', gemini: 'Curioso.', cancer: 'Protettivo.', leo: 'Creativo.', virgo: 'Analitico.', libra: 'Equilibrato.', scorpio: 'Intenso.', sagittarius: 'Ottimista.', capricorn: 'Ambizioso.', aquarius: 'Innovativo.', pisces: 'Compassionevole.' },
    moonSignInterpretations: { aries: 'Passionale.', taurus: 'Stabile.', gemini: 'Comunicativo.', cancer: 'Sensibile.', leo: 'Drammatico.', virgo: 'Analitico.', libra: 'Armonioso.', scorpio: 'Intenso.', sagittarius: 'Libero.', capricorn: 'Disciplinato.', aquarius: 'Indipendente.', pisces: 'Empatico.' },
    risingSignInterpretations: { aries: 'Energico.', taurus: 'Affidabile.', gemini: 'Versatile.', cancer: 'Protettivo.', leo: 'Carismatico.', virgo: 'Pratico.', libra: 'Diplomatico.', scorpio: 'Magnetico.', sagittarius: 'Avventuroso.', capricorn: 'Serio.', aquarius: 'Unico.', pisces: 'Gentile.' },
    mercurySignInterpretations: { aries: 'Diretto.', taurus: 'Pratico.', gemini: 'Versatile.', cancer: 'Intuitivo.', leo: 'Creativo.', virgo: 'Analitico.', libra: 'Diplomatico.', scorpio: 'Intenso.', sagittarius: 'Filosofico.', capricorn: 'Disciplinato.', aquarius: 'Originale.', pisces: 'Poetico.' },
    venusSignInterpretations: { aries: 'Passionale.', taurus: 'Sensuale.', gemini: 'Sociale.', cancer: 'Sensibile.', leo: 'Generoso.', virgo: 'Pratico.', libra: 'Artistico.', scorpio: 'Privato.', sagittarius: 'Ottimista.', capricorn: 'Serio.', aquarius: 'Indipendente.', pisces: 'Compassionevole.' },
    marsSignInterpretations: { aries: 'Dinamico.', taurus: 'Persistente.', gemini: 'Inquieto.', cancer: 'Protettivo.', leo: 'Drammatico.', virgo: 'Efficiente.', libra: 'Equilibrato.', scorpio: 'Potente.', sagittarius: 'Avventuroso.', capricorn: 'Ambizioso.', aquarius: 'Innovativo.', pisces: 'Gentile.' },
    tooltips: { dob: 'Data di nascita.', birthTime: 'Ora di nascita.', timezone: 'Fuso orario.', location: 'Luogo di nascita.', calculate: 'Calcola.', compare: 'Confronta.', holiday: 'Festività.', rangeEnd: 'Fine intervallo.', targetYear: 'Anno target.', share: 'Condividi.', copy: 'Copia.', theme: 'Tema.', language: 'Lingua.' },
    seoSectionTitle: 'Perché usare il nostro Utility Hub?',
    seoSectionContent: 'Il nostro Utility Hub multi-strumento è progettato per semplificare i tuoi calcoli quotidiani. Che tu debba conoscere la tua età esatta, controllare il tuo indice di massa corporea (BMI) o calcolare uno sconto per il tuo prossimo acquisto, forniamo strumenti precisi e facili da usare in un unico posto.',
    seoSectionAge: 'Calcola la tua età esatta in anni, mesi, giorni e persino secondi con il nostro strumento ad alta precisione. Include dettagli sul tema natale, segni zodiacali e statistiche sulla vita come battiti cardiaci totali e respiri.',
    seoSectionBmi: 'Calcola istantaneamente il tuo indice di massa corporea (IMC) con il nostro strumento preciso. Perfetto per monitorare salute, fitness e categorie di peso (sottopeso, normale, sovrappeso, obeso) utilizzando unità metriche o imperiali.',
    seoSectionDiscount: 'Risparmia denaro con il nostro calcolatore di sconti. Trova rapidamente il prezzo finale e il risparmio totale per qualsiasi vendita. Ideale per lo shopping, la pianificazione del budget e gli sconti al dettaglio.',
    seoSectionPercentage: 'Il nostro calcolatore di percentuali gestisce tutte le tue esigenze matematiche. Calcola facilmente le percentuali di numeri, gli aumenti o le diminuzioni percentuali per affari, scuola e finanza quotidiana.',
    seoKeywordsBmi: 'Calcolatore IMC, Indice di Massa Corporea, Tracker Salute, Categoria di Peso, IMC Metrico, IMC Imperiale, Strumento Fitness',
    seoKeywordsAge: 'Calcolatore Età, Età Esatta, Tema Natale, Segno Zodiacale, Statistiche Vita, Conto alla Rovescia Compleanno',
    seoKeywordsDiscount: 'Calcolatore Sconti, Prezzo di Vendita, Strumento Shopping, Calcolatore Risparmi, Sconto al Dettaglio',
    seoKeywordsPercentage: 'Calcolatore Percentuale, Strumento Matematico, Aumento Percentuale, Diminuzione Percentuale, Calcolatore Finanziario'
  },
  pt: {
    title: 'Utility Hub Pro',
    subtitle: 'Ferramentas de utilidade profissional tudo-em-um. Calcule sua idade exata, níveis de IMC e descontos em compras instantaneamente.',
    ...
    resultsTitle: 'Sua Idade Exata',
    ageLabel: 'Idade',
    lunarAge: 'Idade Lunar',
    years: 'Anos',
    months: 'Meses',
    days: 'Dias',
    hours: 'Horas',
    ...
    lifeStatsTitle: 'Estatísticas de Vida (Estimadas)',
    heartbeats: 'Batimentos Cardíacos',
    eyeBlinks: 'Piscadas de Olhos',
    sleepTime: 'Tempo de Sono',
    breathCount: 'Respirações',
    weeks: 'Semanas',
    ageSummary: 'Você tem {years} anos, {months} meses e {days} dias.',
    errorInvalidDate: 'Por favor, insira uma data válida.',
    errorFutureDate: 'A data de nascimento não pode ser no futuro.',
    errorInvalidYear: 'Por favor, insira um ano válido.',
    errorBirthAfterTarget: 'A data de nascimento não pode ser posterior ao ano alvo.',
    errorStartDateAfterEndDate: 'A data de início não pode ser posterior à data de término.',
    errorTooOld: 'Por favor, insira uma data mais recente (nos últimos 150 anos).',
    errorInvalidPrice: 'Por favor, insira um preço positivo válido.',
    errorInvalidDiscount: 'O desconto deve estar entre 0 e 100.',
    date1Label: 'Data de Início',
    date2Label: 'Data de Término',
    compareBtn: 'Calcular Diferença',
    differenceTitle: 'Diferença de Tempo',
    differenceSummary: 'A diferença é de {years} anos, {months} meses e {days} dias.',
    footerText: '© 2026 Utility Hub Pro. Todos os direitos reservados.',
    seoTitle: 'Por que usar uma calculadora de idade?',
    seoDescription: 'Uma calculadora de idade é uma ferramenta que ajuda você a determinar o tempo exato decorrido desde o seu nascimento.',
    selectLanguage: 'Idioma',
    shareBtn: 'Compartilhar Resultados',
    copyBtn: 'Copiar para a Área de Transferência',
    copiedLabel: 'Copiado!',
    holidayLabel: 'Próximo Feriado (Opcional)',
    daysUntilHoliday: 'Faltam {days} dias para o seu feriado!',
    dobRangeEndLabel: 'Fim do Intervalo da Data de Nascimento (Opcional)',
    ageRangeSummary: 'Seu intervalo de idade está entre {min} e {max}.',
    easterDate: 'Data da Páscoa {year}',
    targetYearLabel: 'Ano Alvo (Opcional)',
    holidayCountdownLabel: 'Contagem regressiva para o feriado',
    bmiCalculator: 'Calculadora de IMC',
    discountCalculator: 'Calculadora de Desconto',
    weightLabel: 'Peso (kg)',
    heightLabel: 'Altura (cm)',
    originalPriceLabel: 'Preço Original',
    discountPercentageLabel: 'Desconto %',
    calculateBmiBtn: 'Calcular IMC',
    calculateDiscountBtn: 'Calcular Desconto',
    weightPlaceholder: 'ex. 70',
    heightPlaceholder: 'ex. 175',
    dayPlaceholder: 'DD',
    monthPlaceholder: 'MM',
    ...
    bmiResult: 'Seu IMC é {bmi}',
    bmiCategory: 'Categoria: {category}',
    discountResult: 'Preço Final: {price}',
    savingsLabel: 'Você economiza: {savings}',
    birthChartTitle: 'Seu Mapa Astral',
    birthLocationLabel: 'Local de Nascimento (Cidade, País)',
    sunSignLabel: 'Signo Solar',
    moonSignLabel: 'Signo Lunar',
    risingSignLabel: 'Ascendente',
    ...
    astrologicalSignificanceLabel: 'Significado Astrológico',
    lunarPhaseInterpretations: {
      new_moon: 'Um momento para novos começos, definir intenções e plantar sementes para o futuro.',
      waxing_crescent: 'Uma fase de crescimento, criação de impulso e primeiros passos em direção aos seus objetivos.',
      first_quarter: 'Um momento para ação, superação di obstáculos e tomada de decisões.',
      waxing_gibbous: 'Um período de refinamento, ajuste e preparação para a manifestação completa.',
      full_moon: 'Um momento de culminação, colheita e emoções intensificadas.',
      waning_gibbous: 'Uma fase de gratidão, compartilhamento e reflexão sobre o que foi alcançado.',
      last_quarter: 'Um momento para liberação, desapego e limpeza do que não serve mais.',
      waning_crescent: 'Um período de descanso, entrega e profunda introspecção antes do próximo ciclo.'
    },
    lunarPhaseAstrology: {
      new_moon: 'Simboliza o início de um novo ciclo, oferecendo uma folha em branco e energia fresca.',
      waxing_crescent: 'Representa o surgimento de ideias e o impulso inicial para manifestar desejos.',
      first_quarter: 'Uma fase dinâmica de tensão que impulsiona o progresso e exige compromisso.',
      waxing_gibbous: 'Foca em refinar detalhes e manter o curso em direção à conclusão.',
      full_moon: 'Representa o pico de energia, iluminação e a realização de intenções.',
      waning_gibbous: 'Foca em distribuir sabedoria e processar as lições do ciclo.',
      last_quarter: 'Uma fase de reflexão interna e fechamento de capítulos para se preparar para o novo.',
      waning_crescent: 'Simboliza a liberação final e a sabedoria ganha através da jornada.'
    },
    planetaryPositionsTitle: 'Posições Planetárias',
    housesTitle: 'Casas Astrológicas',
    ...
    calculatePercentageBtn: 'Calcular Porcentagem',
    percentageResult: '{percentage}% de {number} é {result}',
    bmiCategories: {
    ...
    ageDescription: 'Calcule sua idade exata em anos, meses, dias e até segundos. Descubra seu signo do zodíaco e pedra de nascimento.',
    bmiDescription: 'Calcule rapidamente seu Índice de Massa Corporal (IMC) para entender sua categoria de peso e estado de saúde.',
    discountDescription: 'Descubra facilmente quanto você economiza e o preço final após aplicar uma porcentagem de desconto.',
    percentageDescription: 'Calcule porcentagens de qualquer número rapidamente para tarefas de negócios, escola ou vida diária.',
    home: 'Início',
    about: 'Sobre',
    contact: 'Contato',
    aboutTitle: 'Sobre o Utility Hub Pro',
    aboutContent: 'O Utility Hub Pro é o seu destino único para ferramentas de utilidade profissionais, precisas e fáceis de usar. Nossa missão é fornecer calculadoras de alta qualidade que ajudem as pessoas em suas tarefas diárias.',
    ...
    privacyDesc: 'Seus dados nunca saem do seu navegador. Não armazenamos suas informações pessoais nem os resultados de seus cálculos.',
    speedTitle: 'Velocidade Relâmpago',
    speedDesc: 'Otimizado para desempenho, nossas ferramentas fornecem resultados instantâneos com animações suaves.',
    globalTitle: 'Suporte Global',
    globalDesc: 'Disponível em vários idiomas e fusos horários para atender usuários em todo o mundo.',
    privacyPolicy: 'Política de Privacidade',
    termsOfService: 'Termos de Serviço',
    privacyPolicyTitle: 'Política de Privacidade',
    privacyPolicyLastUpdated: 'Última atualização: 25 de março de 2026',
    privacyPolicySections: [
      { title: 'Introdução', content: 'Bem-vindo ao Utility Hub Pro. Valorizamos sua privacidade e estamos comprometidos em proteger seus dados pessoais.' },
      { title: 'Coleta de Dados', content: 'Não coletamos nem armazenamos nenhuma informação pessoal em nossos servidores. Todos os cálculos são realizados localmente no seu navegador.' }
    ],
    aspectsTitle: 'Aspectos Astrológicos',
    aspectTypes: { conjunction: 'Conjunção', sextile: 'Sêxtil', square: 'Quadrado', trine: 'Trígono', opposition: 'Oposição' },
    aspectDescriptions: { conjunction: 'Os planetas estão próximos, fundindo suas energias.', sextile: 'Um ângulo harmonioso de 60 graus.', square: 'Um ângulo desafiador de 90 graus.', trine: 'Um ângulo favorável de 120 graus.', opposition: 'Os planetas estão a 180 graus de distância.' },
    planetNames: { sun: 'Sol', moon: 'Lua', mercury: 'Mercúrio', venus: 'Vênus', mars: 'Marte' },
    planetMeanings: { sun: 'Identidade central.', moon: 'Emoções e instintos.', mercury: 'Comunicação e intelecto.', venus: 'Amor e beleza.', mars: 'Ação e energia.', rising: 'Personalidade social.' },
    zodiacInterpretationsTitle: 'Interpretações do Zodíaco',
    zodiacReferenceTitle: 'Explore os 12 Signos do Zodíaco',
    lightMode: 'Modo Claro',
    darkMode: 'Modo Escuro',
    zodiacSigns: { aquarius: 'Aquário', pisces: 'Peixes', aries: 'Áries', taurus: 'Touro', gemini: 'Gêmeos', cancer: 'Câncer', leo: 'Leão', virgo: 'Virgem', libra: 'Libra', scorpio: 'Escorpião', sagittarius: 'Sagitário', capricorn: 'Capricórnio' },
    zodiacDescriptions: { aquarius: 'Inovador e humanitário.', pisces: 'Compassivo e intuitivo.', aries: 'Entusiasta e dinâmico.', taurus: 'Forte e confiável.', gemini: 'Versátil e expressivo.', cancer: 'Intuitivo e protetor.', leo: 'Dramático e confiante.', virgo: 'Analítico e gentil.', libra: 'Diplomático e artístico.', scorpio: 'Apaixonado e tenaz.', sagittarius: 'Otimista e aventureiro.', capricorn: 'Disciplinado e ambicioso.' },
    chineseZodiacSigns: { rat: 'Rato', ox: 'Boi', tiger: 'Tigre', rabbit: 'Coelho', dragon: 'Dragão', snake: 'Serpente', horse: 'Cavalo', goat: 'Cabra', monkey: 'Macaco', rooster: 'Galo', dog: 'Cão', pig: 'Porco' },
    chineseZodiacDescriptions: { rat: 'Engenhoso.', ox: 'Diligente.', tiger: 'Corajoso.', rabbit: 'Tranquilo.', dragon: 'Confiante.', snake: 'Sábio.', horse: 'Enérgico.', goat: 'Gentil.', monkey: 'Inteligente.', rooster: 'Trabalhador.', dog: 'Honesto.', pig: 'Generoso.' },
    lunarPhases: { new_moon: 'Lua Nova', waxing_crescent: 'Lua Crescente', first_quarter: 'Quarto Crescente', waxing_gibbous: 'Lua Gibosa Crescente', full_moon: 'Lua Cheia', waning_gibbous: 'Lua Gibosa Minguante', last_quarter: 'Quarto Minguante', waning_crescent: 'Lua Minguante' },
    birthstones: { january: 'Granada', february: 'Ametista', march: 'Água-marinha', april: 'Diamante', may: 'Esmeralda', june: 'Pérola', july: 'Rubi', august: 'Peridoto', september: 'Safira', october: 'Opala', november: 'Topázio', december: 'Turquesa' },
    elements: { fire: 'Fogo', earth: 'Terra', air: 'Ar', water: 'Água' },
    modalities: { cardinal: 'Cardinal', fixed: 'Fixo', mutable: 'Mutável' },
    rulingPlanets: { sun: 'Sol', moon: 'Lua', mercury: 'Mercúrio', venus: 'Vênus', mars: 'Marte', jupiter: 'Júpiter', saturn: 'Saturno', uranus: 'Urano', neptune: 'Netuno', pluto: 'Plutão' },
    elementMeanings: { fire: 'Enérgico e apaixonado.', earth: 'Prático e confiável.', air: 'Intelectual e social.', water: 'Emocional e intuitivo.' },
    modalityMeanings: { cardinal: 'Iniciadores.', fixed: 'Construtores.', mutable: 'Adaptadores.' },
    rulingPlanetMeanings: { mars: 'Ação.', venus: 'Amor.', mercury: 'Comunicação.', moon: 'Emoções.', sun: 'Vitalidade.', pluto: 'Transformação.', jupiter: 'Expansão.', saturn: 'Estrutura.', uranus: 'Inovação.', neptune: 'Sonhos.' },
    sunSignDetailedDescription: 'O Sol representa sua identidade central.',
    sunSignInterpretations: { aries: 'Pioneiro.', taurus: 'Âncora.', gemini: 'Curioso.', cancer: 'Protetor.', leo: 'Criativo.', virgo: 'Analítico.', libra: 'Equilibrado.', scorpio: 'Intenso.', sagittarius: 'Otimista.', capricorn: 'Ambicioso.', aquarius: 'Inovador.', pisces: 'Compassivo.' },
    moonSignInterpretations: { aries: 'Passional.', taurus: 'Estável.', gemini: 'Comunicativo.', cancer: 'Sensível.', leo: 'Dramático.', virgo: 'Analítico.', libra: 'Harmonioso.', scorpio: 'Intenso.', sagittarius: 'Livre.', capricorn: 'Disciplinado.', aquarius: 'Independente.', pisces: 'Empático.' },
    risingSignInterpretations: { aries: 'Enérgico.', taurus: 'Confiável.', gemini: 'Versátil.', cancer: 'Protetor.', leo: 'Carismático.', virgo: 'Prático.', libra: 'Diplomático.', scorpio: 'Magnético.', sagittarius: 'Aventureiro.', capricorn: 'Sério.', aquarius: 'Único.', pisces: 'Gentil.' },
    mercurySignInterpretations: { aries: 'Direto.', taurus: 'Prático.', gemini: 'Versátil.', cancer: 'Intuitivo.', leo: 'Criativo.', virgo: 'Analítico.', libra: 'Diplomático.', scorpio: 'Intenso.', sagittarius: 'Filosófico.', capricorn: 'Disciplinado.', aquarius: 'Original.', pisces: 'Poético.' },
    venusSignInterpretations: { aries: 'Passional.', taurus: 'Sensual.', gemini: 'Social.', cancer: 'Sensível.', leo: 'Generoso.', virgo: 'Prático.', libra: 'Artístico.', scorpio: 'Privado.', sagittarius: 'Otimista.', capricorn: 'Sério.', aquarius: 'Independente.', pisces: 'Compassivo.' },
    marsSignInterpretations: { aries: 'Dinâmico.', taurus: 'Persistente.', gemini: 'Inquieto.', cancer: 'Protetor.', leo: 'Dramático.', virgo: 'Eficiente.', libra: 'Equilibrado.', scorpio: 'Poderoso.', sagittarius: 'Aventureiro.', capricorn: 'Ambicioso.', aquarius: 'Inovador.', pisces: 'Gentil.' },
    tooltips: { dob: 'Data de nascimento.', birthTime: 'Hora de nascimento.', timezone: 'Fuso horário.', location: 'Local de nascimento.', calculate: 'Calcular.', compare: 'Comparar.', holiday: 'Feriado.', rangeEnd: 'Fim do intervalo.', targetYear: 'Ano alvo.', share: 'Compartilhar.', copy: 'Copiar.', theme: 'Tema.', language: 'Idioma.' },
    seoSectionTitle: 'Por que usar nosso Utility Hub?',
    seoSectionContent: 'Nosso Utility Hub multi-ferramenta foi projetado para simplificar seus cálculos diários. Se você precisa saber sua idade exata, verificar seu índice de massa corporal (IMC) ou calcular um desconto para sua próxima compra, fornecemos ferramentas precisas e fáceis de usar em um só lugar.',
    seoSectionAge: 'Calcule sua idade exata em anos, meses, dias e até segundos com nossa ferramenta de alta precisão. Inclui detalhes do mapa astral, signos do zodíaco e estatísticas de vida, como total de batimentos cardíacos e respirações.',
    seoSectionBmi: 'Calcule seu Índice de Massa Corporal (IMC) instantaneamente com nossa ferramenta precisa. Perfeito para acompanhar saúde, condicionamento físico e categorias de peso (baixo peso, normal, sobrepeso, obeso) usando unidades métricas ou imperiais.',
    seoSectionDiscount: 'Economize dinheiro com nossa calculadora de descontos. Encontre rapidamente o preço final e a economia total para qualquer venda. Ideal para compras, planejamento de orçamento e descontos no varejo.',
    seoSectionPercentage: 'Nossa calculadora de porcentagem lida com todas as suas necessidades matemáticas. Calcule facilmente porcentagens de números, aumentos ou reduções percentuais para negócios, escola e finanças diárias.',
    seoKeywordsBmi: 'Calculadora de IMC, Índice de Massa Corporal, Rastreador de Saúde, Categoria de Peso, IMC Métrico, IMC Imperial, Ferramenta de Fitness',
    seoKeywordsAge: 'Calculadora de Idade, Idade Exata, Mapa Astral, Signo do Zodíaco, Estatísticas de Vida, Contagem Regressiva de Aniversário',
    seoKeywordsDiscount: 'Calculadora de Descontos, Preço de Venda, Ferramenta de Compras, Calculadora de Economia, Desconto no Varejo',
    seoKeywordsPercentage: 'Calculadora de Porcentagem, Ferramenta Matemática, Aumento Percentual, Diminuição Percentual, Calculadora Financeira'
  }
};
