...
const Contact: React.FC = () => {
  ...
  return (
    <motion.div
      ...
      className={`p-8 md:p-12 rounded-3xl glass-card shadow-2xl max-w-2xl mx-auto`}
    >
      ...
      {submitted ? (
        <motion.div
          ...
          className={`p-12 rounded-3xl border-2 text-center flex flex-col items-center gap-4 ${
